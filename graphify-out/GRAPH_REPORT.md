...
## Corpus Check
- 82 files · ~81,351 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 417 nodes · 1190 edges · 25 communities (22 shown, 3 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b0be8ca5`
...
4. `normalizePrizeMode()` - 25 edges
5. `handle()` - 23 edges
6. `sendGuildLog()` - 19 edges
7. `logger` - 19 edges
8. `isManager()` - 19 edges
9. `rerollSingle()` - 18 edges
10. `giveawayPrizes()` - 16 edges
...
Cohesion: 0.07
Nodes (40): __dirname, main(), __dirname, fail(), main(), ok(), SRC, client (+32 more)

### Community 1 - "prizes.test.js"
Cohesion: 0.16
Nodes (21): calls, guildWithStore(), giveawayWithEntries(), NO_LIMITS, users, addEntries(), cleanup(), createTestGiveaway() (+13 more)
...
### Community 3 - "settingsService.js"
Cohesion: 0.10
Nodes (26): BUTTON_CHOICES, execute(), parseArr(), parseObj(), execute(), setGiveawayBlacklistRoles(), setGiveawayBonusRoles(), setGiveawayWhitelistRoles() (+18 more)

### Community 4 - "giveawayService.js"
Cohesion: 0.09
Nodes (57): execute(), execute(), execute(), PERMISSIONS, execute(), execute(), execute(), execute() (+49 more)

### Community 5 - "controlServer.js"
Cohesion: 0.11
Nodes (34): clearTebex(), getGiveawayDetail(), handle(), isGuildOwner(), listChannels(), listGiveaways(), listRoles(), publicSettings() (+26 more)

### Community 6 - "getSettings"
Cohesion: 0.17
Nodes (31): execute(), execute(), execute(), execute(), execute(), execute(), execute(), editGiveawayEndpoint() (+23 more)

### Community 7 - "gtemplate.js"
Cohesion: 0.20
Nodes (14): execute(), REQUIRED_PERMS, execute(), REQUIRED_PERMS, createGiveawayEndpoint(), parseCouponInput(), createGiveaway(), postGiveaway() (+6 more)
...
## Knowledge Gaps
- **73 isolated node(s):** `__dirname`, `name`, `version`, `description`, `type` (+68 more)
...
- **Why does `openTestDb()` connect `prizes.test.js` to `logger.js`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `t()` connect `giveawayService.js` to `logger.js`, `settingsService.js`, `controlServer.js`, `getSettings`, `gtemplate.js`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `getSettings()` connect `getSettings` to `logger.js`, `settingsService.js`, `giveawayService.js`, `controlServer.js`, `gtemplate.js`?**
