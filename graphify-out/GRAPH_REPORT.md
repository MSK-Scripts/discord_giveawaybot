# Graph Report - discord_giveaway  (2026-09-04)

## Corpus Check
- 99 files · ~106,198 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 511 nodes · 1590 edges · 30 communities (28 shown, 2 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7adc7383`
...
### Community 0 - "settingsService.js"
Cohesion: 0.06
Nodes (48): __dirname, main(), __dirname, fail(), main(), ok(), SRC, client (+40 more)

### Community 1 - "i18n.js"
Cohesion: 0.07
Nodes (44): getLang(), DEFAULT_LANG, __dirname, interpolate(), locales, LOCALES_DIR, resolveLang(), SUPPORTED_LANGS (+36 more)
...
Cohesion: 0.09
Nodes (60): execute(), execute(), execute(), PERMISSIONS, execute(), execute(), execute(), addOrRemoveEntry() (+52 more)

### Community 5 - "controlServer.js"
Cohesion: 0.08
Nodes (64): execute(), REQUIRED_PERMS, execute(), REQUIRED_PERMS, clearTebex(), createGiveawayEndpoint(), deleteTemplateEndpoint(), getGiveawayDetail() (+56 more)

### Community 6 - "getSettings"
Cohesion: 0.11
Nodes (44): execute(), execute(), execute(), execute(), execute(), execute(), execute(), execute() (+36 more)

### Community 7 - "tebexService.js"
Cohesion: 0.10
Nodes (31): revealTebexSecret(), setTebexSecret(), warnAboutManualCodes(), couponConfigured(), couponPackagesForWinner(), formatExpiry(), generateCouponCode(), issueCoupons() (+23 more)
...
## Knowledge Gaps
- **82 isolated node(s):** `__dirname`, `name`, `version`, `description`, `type` (+77 more)
...
- **Why does `t()` connect `giveawayService.js` to `settingsService.js`, `i18n.js`, `controlServer.js`, `getSettings`, `tebexService.js`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `getSettings()` connect `getSettings` to `settingsService.js`, `giveawayService.js`, `controlServer.js`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `logger` connect `settingsService.js` to `giveawayService.js`, `controlServer.js`, `getSettings`, `tebexService.js`?**
